...
export default {
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              description:
                "Italian vegetable soup with beans, pasta, and tomatoes",
              price: 6.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
            ...
            },
            {
              ...
              name: "Lentil Soup",
              description:
                "Hearty lentil soup with carrots, celery, and onions",
              price: 5.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
            ...
            },
            {
              ...
              name: "Pumpkin Soup",
              description:
                "Seasonal pumpkin soup with a hint of cinnamon and nutmeg",
              price: 5.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
        ...
        },
        {
          ...
          items: [
            ...
            },
            {
              ...
              name: "Spinach Salad",
              description:
                "Fresh spinach with goat cheese, walnuts, and cranberries",
              price: 8.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
            ...
            },
            {
              ...
              name: "Kale Salad",
              description:
                "Fresh kale with lemon vinaigrette, almonds, and parmesan",
              price: 7.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
            {
              ...
              name: "Avocado Salad",
              description:
                "Sliced avocado with mixed greens and citrus vinaigrette",
              price: 8.0,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
            {
              ...
              name: "Waldorf Salad",
              description:
                "Fresh apples, walnuts, and grapes in a creamy dressing",
              price: 7.5,
              image: "https://placehold.co/600x400",
              quantity: 1,
            },
  ...
  computed: {
    categories() {
      return this.menuData.map((category) => category.category);
    },
    itemsCheck() {
      const checkedItems = this.menuData.reduce((acc, category) => {
